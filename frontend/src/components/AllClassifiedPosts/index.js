...
function AllClassifiedPosts() {
  ...
  useEffect(() => {
    const fetchPosts = async () => {
      ...
      try {
        ...
        setError("Không thể lấy danh sách bài viết phân loại");
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="section">
      <h2>Bài Viết Đã Phân Loại (Tổng: {totalPosts} bài)</h2>
      {error && (
        <div className="error">
          <h3>Lỗi:</h3>
          <p>{error}</p>
...
export default AllClassifiedPosts;